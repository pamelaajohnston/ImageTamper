...
if __name__ == "__main__":
    ...
    my_data = my_data.reshape((len(dataFiles), patchedFrames, patchHeight, patchWidth))
    ...
    inputShape = (patchHeight, patchWidth, len(dataFiles))
    chanDim = 1
    num_classes = 2

    #model.add(Dense(1024, input_shape=(4,), activation="sigmoid"))
